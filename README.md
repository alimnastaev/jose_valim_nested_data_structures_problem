...
This repository has been archived with many different solutions across multiple languages and lives here:
https://github.com/josevalim/nested-data-structure-traversal

(My solution lives inside `elixir` folder if you interested.)
